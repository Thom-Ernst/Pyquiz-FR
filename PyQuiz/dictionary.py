...
louis_armstron_what_a_wonderful_world = Track_class("What a Wonderful World", 'music/louis_armstron_what_a_wonderful_world.ogg')
...
ode_to_joy = Track_class("Ode Aan de Vreaugde", 'music/ode_to_joy.ogg')
